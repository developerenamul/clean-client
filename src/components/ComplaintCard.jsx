...
const ComplaintCard = ({ issue }) => {
  return (
    <div className="shadow-lg rounded-xl overflow-hidden flex flex-col justify-between bg-white hover:shadow-2xl transition-all duration-300 w-11/12 mx-auto">
      {/* Image */}
      <img
        src={issue.image}
        alt={issue.title}
